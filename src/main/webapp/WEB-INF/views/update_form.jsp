			...
			<div class="col-md-6 offset-md-3">
				...
				<form action="${pageContext.request.contextPath }/handle-product" method="post">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="type" id="description"
							rows="5" placeholder="Enter the product description" value="${product.type }">

					</div>

					<div class="form-group">

						<label for="price">Product Category</label> <input type="text"
							placeholder="Enter Product Category" name="category"
							class="form-control" id="category" value="${product.category }">
